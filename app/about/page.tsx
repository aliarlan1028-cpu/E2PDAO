...
export default function AboutPage(){return <>
  ...
  <section id="participate" className="v4-about-participate"><div className="v4-wrap"><span className="v4-label">Ways to participate</span><div><a href={E2P_LINKS.project("about_project_v4")}><Sprout/><h3>Projects</h3><p>Early-stage teams can access the Incubator to validate, build and prepare for scale.</p><ArrowRight/></a><a href={E2P_LINKS.kol("about_creator_v4")}><Users/><h3>Creators</h3><p>KOLs and creators can find aligned opportunities and build long-term value with their audiences.</p><ArrowRight/></a><a href={E2P_LINKS.partner("about_partner_v4")}><Handshake/><h3>Partners</h3><p>Operators, funds and organisations can collaborate through clear mandates and shared outcomes.</p><ArrowRight/></a><a href={E2P_LINKS.telegram}><Radar/><h3>Community</h3><p>Support the network, share feedback and help us improve every cycle.</p><ArrowRight/></a></div></div></section>
